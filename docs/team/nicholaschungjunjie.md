...
* Implemented validation classes for add item, update item, menu assistant commands.
* Implemented the item package
* Implemented Junit test cases for item package.

### Contributions to DG
* Wrote the section of item for both assist and pro mode